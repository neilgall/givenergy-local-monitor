...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output", required=True, type=Path, help="Output OpenMetrics file path")
    return parser
...
def main() -> int:
    ...
    print(
        f"Wrote {written_samples} samples across {len(written_types)} metrics to {args.output}",
        file=sys.stderr,
    )
    return 0
